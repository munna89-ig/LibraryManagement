...
{
    public partial class MemberOperation : Form
    {
        ...
        private void btnInsert_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string insertQuery = "INSERT INTO Users (Name, E_mail, Phone, Address, Password, Role) " +
                     "VALUES ('" + name + "', '" + mail + "', '" + phn + "', '" + add + "', '" + pass + "', 'Member')";
                SqlCommand insertCmd = new SqlCommand(insertQuery, conn);
                insertCmd.ExecuteNonQuery();

                MessageBox.Show("Insert Member", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                conn.Close();
        ...
        private void MemberOperation_Load(object sender, EventArgs e)
        {
            this.LoadUserInfo();
